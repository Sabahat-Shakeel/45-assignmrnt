...
let album2: Album = make_album("Artist2", "Album Title 2", 12); // With number of tracks
...
make_great1(magicians); // Modifies the original array
...
const magicianss: string[] = ["Merlin", "Gandalf", "Houdini"];

// Create a copy of the original array
const originalMagicianss: string[] = [...magicianss];

// Call makeGreat with a copy of the original array
const greatMagicians: string[] = makeGreat([...magicianss]);

// Display the original array
console.log("Original Magicians:");
showMagicians(originalMagicianss);

// Display the array with 'Great' added to each magician's
...
// Example usage
const myCar = createCar("Toyota", "Corolla", ["color", "red"], ["year", 2020], ["sunroof", true]);
console.log(myCar);
